...
public class CourseForm extends javax.swing.JFrame {
    ...
    private controller.CourseController controller = new controller.CourseController();

    // membuat new form untuk courseform
    public CourseForm() {
        initComponents();
        controller.refreshTable(jTableCourse); // menampilkan data matkul ke tabel
    }
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(txtNamaMK, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 177, Short.MAX_VALUE)
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        int baris = jTableCourse.getSelectedRow();
        if (baris == -1) {
            javax.swing.JOptionPane.showMessageDialog(this, "Pilih baris di tabel terlebih dahulu!");
            return;
        }
        String kode = jTableCourse.getValueAt(baris, 0).toString();
        controller.deleteCourse(this, kode, jTableCourse);
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        controller.saveCourse(this, txtKode.getText(), txtNamaMK.getText(), txtSKS.getText(), txtSemester.getText(), jTableCourse);
        // Kosongkan inputan setelah simpan
        txtKode.setText(""); txtNamaMK.setText(""); txtSKS.setText(""); txtSemester.setText("");
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // Mengosongkan semua JTextField di Form Mata Kuliah
        txtKode.setText("");
        txtNamaMK.setText("");
        txtSKS.setText("");
        txtSemester.setText("");

        // membuat txtkode bisa diketik kembali jika sebelumnya dikunci saat edit
        txtKode.setEditable(true);
    }//GEN-LAST:event_jButton3ActionPerformed

    // fungsi tombol nack
    private void jButtonBackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonBackActionPerformed
        // membuat objek dahsbaoordform baru
